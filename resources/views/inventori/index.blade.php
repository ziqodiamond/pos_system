    ...
    <div>
        ...
        <div class="grid gap-4 grid-cols-3 xs:grid-cols-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6">
            ...
            <a href="{{ route('stok-barang.index') }}"
                ...
                <span class="font-semibold text-center text-xs sm:text-xs md:text-sm lg:text-md">Data Stok Barang</span>
            </a>
            ...
            <a href="{{ route('mutasi.index') }}"
                ...
                <span class="font-semibold text-center text-xs sm:text-xs md:text-sm lg:text-md">Mutasi Barang</span>
            </a>
