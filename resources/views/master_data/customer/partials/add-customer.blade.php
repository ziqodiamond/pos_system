<!-- Modal -->
<div x-show="addModal" x-data="{ statusText: 'Nonaktif' }" x-cloak
        ...
        <form action="{{ route('customer.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="alamat" id="alamat" rows="1" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm"></textarea>
                </div>
