<x-layout>
    ...
    <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-4 m-2">
        <div class="flex justify-between items-center mb-3">
            <h2 class="text-2xl font-bold">Daftar Satuan</h2>
            <div x-data="{ modalOpen: false }">
                ...
                <div x-show="modalOpen" x-transition:enter="transition ease-out duration-300"
                    ...
                    <div x-show="modalOpen" x-transition:enter="transition ease-out duration-300"
                        ...
                        <!-- Filter Form -->
                        <form action="{{ route('satuan.pdf') }}" method="GET" target="_blank">
                            <div class="space-y-4">
                                <!-- Filter Status -->
                                <div>
                                    <label for="status"
                                ...
                                <!-- Filter Status Satuan -->
                                <div>
                                    <label for="status_satuan"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                        Status Satuan
                                    </label>
                                    <input type="text" id="status_satuan" name="status_satuan"
                                        placeholder="Masukkan status satuan..."
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="grid grid-cols-2 gap-2">
                                        <select name="sort_by"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                            <option value="nama">Nama Satuan</option>
                                            <option value="kode">Kode Satuan</option>
                                            <option value="status_satuan">Status Satuan</option>
        ...
        <div class="overflow-x-auto">
            ...
            <div class="relative bg-white  dark:bg-gray-800 sm:rounded-lg">
                @include('master_data.satuan.partials.table-header')
            </div>


            {{-- table --}}
            <div id="table-container" class="overflow-x-auto shadow-md sm:rounded-lg mt-2">
                @include('master_data.satuan.partials.table')
            </div>
