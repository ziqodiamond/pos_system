...
<div x-show="addModal" x-cloak class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
    <div class="bg-white p-6 rounded-lg w-full max-w-2xl @click.outside="addModal=false"">
        ...
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-lg font-semibold">Tambah Satuan</h2>
        ...
        <form action="{{ route('satuan.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mt-4">
                <label for="status_satuan" class="block text-sm font-medium text-gray-700">Status Satuan</label>
                <select name="status_satuan" id="status_satuan"
                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    <option value="satuan_dasar">Satuan Dasar</option>
                    <option value="konversi_satuan">Satuan Konversi</option>
                </select>
            </div>
