<div class="flex flex-col items-center justify-between p-4 space-y-3 md:flex-row md:space-y-0 md:space-x-4">
        ...
        <form class="flex items-center">
            ...
            <div class="relative w-full">
                ...
                <input type="text" id="search"
                    ...
                    placeholder="Cari Berdasarkan Kode dan Nama Satuan">
            </div>
        </form>
    ...
    <div
        ...
        <div x-data="{ addModal: false, step: 1 }" @open-add-modal.window="addModal = true">
            ...
            @include('master_data.satuan.partials.add-satuan')
        </div>
        <div class="flex items-center w-full space-x-3 md:w-auto">
            ...
            <div id="actionsDropdown" x-data="{ showModal: false, actionType: '', confirmMessage: '', selectedStatus: '' }"
                ...
                <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="actionsDropdownButton">
                    ...
                    <li class="hover:bg-gray-100 dark:hover:bg-gray-600" id="editAction">
                        <button type="button" @click="showModal=true; actionType='edit'; confirmMessage='Edit satuan?'"
                    ...
                    <li class="hover:bg-gray-100 dark:hover:bg-gray-600" id="deleteAction">
                        <button type="button"
                            @click="showModal=true; actionType='delete'; confirmMessage='Yakin ingin menghapus satuan terpilih?'"
                    ...
                    <li class="hover:bg-gray-100 dark:hover:bg-gray-600 hidden" id="restoreAction">
                        <button type="button"
                            @click="showModal=true; actionType='restore'; confirmMessage='Yakin ingin merestore satuan terpilih?'"
                            class="block w-full text-left px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                            Restore
                        </button>
                    </li>
                    <li class="hover:bg-gray-100 dark:hover:bg-gray-600 hidden" id="forceDeleteAction">
                        <button type="button"
                            @click="showModal=true; actionType='forceDelete'; confirmMessage='Yakin ingin menghapus permanen satuan terpilih?'"
                ...
                <div x-show="showModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center"
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-lg dark:bg-gray-700">
                        ...
                        <form action="{{ route('satuan.bulkAction') }}" method="POST">
                            @csrf
            ...
            <x-master-filter :filterGroups="[
                ...
                'Jenis' => [
                    ['kode' => 'satuan_dasar', 'nama' => 'Satuan Dasar'],
                    ['kode' => 'konversi_satuan', 'nama' => 'Satuan Konversi'],
                ],
