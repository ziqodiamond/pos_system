    ...
    <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-4 m-2">
            ...
            <div x-data="{ modalOpen: false }">
                ...
                <div x-show="modalOpen" x-transition:enter="transition ease-out duration-300"
                    ...
                    <div x-show="modalOpen" x-transition:enter="transition ease-out duration-300"
                        ...
                        <!-- Filter Form -->
                        <form action="{{ route('supplier.pdf') }}" method="GET" target="_blank">
                            <div class="space-y-4">
                                <!-- Filter Status -->
                                <div>
                                    <label for="status"
                                ...
                                <div>
                                    ...
                                    <div class="grid grid-cols-2 gap-2">
                                        <select name="sort_by"
                                            ...
                                            <option value="kode">Kode Supplier</option>
        ...
        <div class="overflow-x-auto">
            ...
            <div class="relative bg-white  dark:bg-gray-800 sm:rounded-lg">
                @include('master_data.supplier.partials.table-header')
            </div>


            {{-- table --}}
            <div id="table-container" class="overflow-x-auto shadow-md sm:rounded-lg mt-2">
                @include('master_data.supplier.partials.table')
            </div>
