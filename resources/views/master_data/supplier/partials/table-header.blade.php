        ...
        <form class="flex items-center">
            ...
            <div class="relative w-full">
                ...
                <input type="text" id="search"
                    ...
                    placeholder="Cari Berdasarkan Kode dan Nama Supplier">
            </div>
        </form>
    </div>
    <div
        ...
        <div x-data="{ addModal: false, step: 1 }" @open-add-modal.window="addModal = true">
            ...
            @include('master_data.supplier.partials.add-supplier')
        </div>
            ...
            <div id="actionsDropdown" x-data="{ showModal: false, actionType: '', confirmMessage: '', selectedStatus: '' }"
                ...
                <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="actionsDropdownButton">
                    ...
                    <li class="hover:bg-gray-100 dark:hover:bg-gray-600" id="editAction">
                        <button type="button"
                            @click="showModal=true; actionType='edit'; confirmMessage='Edit supplier terpilih?'"
                    ...
                    <li class="hover:bg-gray-100 dark:hover:bg-gray-600" id="deleteAction">
                        <button type="button"
                            @click="showModal=true; actionType='delete'; confirmMessage='Yakin ingin menghapus supplier terpilih?'"
                    ...
                    <li class="hover:bg-gray-100 dark:hover:bg-gray-600 hidden" id="restoreAction">
                        <button type="button"
                            @click="showModal=true; actionType='restore'; confirmMessage='Yakin ingin merestore supplier terpilih?'"
                            class="block w-full text-left px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                            Restore
                        </button>
                    </li>
                    <li class="hover:bg-gray-100 dark:hover:bg-gray-600 hidden" id="forceDeleteAction">
                        <button type="button"
                            @click="showModal=true; actionType='forceDelete'; confirmMessage='Yakin ingin menghapus permanen supplier terpilih?'"
                ...
                <div x-show="showModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center"
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-lg dark:bg-gray-700">
                        ...
                        <form action="{{ route('supplier.bulkAction') }}" method="POST">
                            @csrf
