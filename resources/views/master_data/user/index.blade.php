<x-layout>
    ...
    <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-4 m-2">
            ...
            <div x-data="{ modalOpen: false }">
                ...
                <div x-show="modalOpen" x-transition:enter="transition ease-out duration-300"
                    ...
                    <div x-show="modalOpen" x-transition:enter="transition ease-out duration-300"
                        ...
                        <!-- Filter Form -->
                        <form action="{{ route('user.pdf') }}" method="GET" target="_blank">
                            <div class="space-y-4">
                                <!-- Filter Status -->
                                <div>
                                    <label for="status"
        ...
        <div class="overflow-x-auto">
            ...
            <div class="relative bg-white  dark:bg-gray-800 sm:rounded-lg">
                @include('master_data.user.partials.table-header')
            </div>


            {{-- table --}}
            <div id="table-container" class="overflow-x-auto shadow-md sm:rounded-lg mt-2">
                @include('master_data.user.partials.table')
            </div>
    ...
    <script>
        const reportSearchRoute = @json(route('user.index'));
