<x-layout>
    ...
    <div class="bg-white shadow-md rounded-lg p-4 m-2">
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-xl font-semibold">Faktur Pembelian</h2>
            <button type="button"
        ...
        <div class="overflow-x-auto">
            ...
            <div id="table-header" class="relative bg-white  dark:bg-gray-800 sm:rounded-lg">
                @include('pembelian.faktur-pembelian.partials.table-header')
            </div>


            {{-- table --}}
            <div id="table-container" class="overflow-x-auto shadow-md sm:rounded-lg mt-2">
                @include('pembelian.faktur-pembelian.partials.table')
            </div>
    ...
    <script>
        const reportSearchRoute = @json(route('faktur.index'));
