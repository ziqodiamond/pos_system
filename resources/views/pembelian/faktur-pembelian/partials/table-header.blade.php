    ...
    <div
        ...
        <div class="flex items-center w-full space-x-3 md:w-auto">
            ...
            <div id="actionsDropdown" x-data="{ showModal: false, actionType: '', confirmMessage: '', selectedStatus: '' }"
                ...
                <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="actionsDropdownButton">
                    ...
                    <li class="hover:bg-gray-100 dark:hover:bg-gray-600" id="selesaiAction">
                        <button type="button"
                            @click="showModal=true; actionType='bayar'; confirmMessage='Selesai massal pembelian terpilih?'"
                    ...
                    <li class="hover:bg-gray-100 dark:hover:bg-gray-600" id="selesaiAction">
                        <button type="button"
                            @click="showModal=true; actionType='batal'; confirmMessage='Batal massal pembelian terpilih?'"
                            class="block w-full text-left px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                            Batal
                        </button>
                    </li>
                    <li class="hover:bg-gray-100 dark:hover:bg-gray-600" id="deleteAction">
                        <button type="button"
                            @click="showModal=true; actionType='delete'; confirmMessage='Yakin ingin menghapus pembelian terpilih?'"
                ...
                <div x-show="showModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center"
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-lg dark:bg-gray-700">
                        ...
                        <form action="{{ route('pembelian.bulkAction') }}" method="POST">
                            @csrf
            ...
            <x-master-filter :filterGroups="[
                ...
                'Status' => [
                    ['kode' => 'processing', 'nama' => 'Proses'],
                    ['kode' => 'compleited', 'nama' => 'Selesai'],
                    ['kode' => 'canceled', 'nama' => 'Dibatalkan'],
