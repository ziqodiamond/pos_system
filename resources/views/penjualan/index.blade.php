<x-layout>
    <div>
        ...
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold">Menu Penjualan</h1>
        </div>
        ...
        <div class="grid gap-4 grid-cols-3 xs:grid-cols-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6">
            ...
            <a href="{{ route('pembelian.create') }}"
                ...
                <span class="font-semibold text-center text-xs sm:text-xs md:text-sm lg:text-md">Transaksi Baru</span>
            </a>
            ...
            <a href="#"
                ...
                <span class="font-semibold text-center text-xs sm:text-xs md:text-sm lg:text-md">Daftar Penjualan</span>
            </a>
            ...
            <a href="#"
                ...
                <span class="font-semibold text-center text-xs sm:text-xs md:text-sm lg:text-md">Barang Keluar</span>
            </a>
            ...
            <a href="#"
                ...
                <span class="font-semibold text-center text-xs sm:text-xs md:text-sm lg:text-md">Retur Penjualan</span>
            </a>
